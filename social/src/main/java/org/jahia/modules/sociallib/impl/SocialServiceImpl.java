...
package org.jahia.modules.sociallib.impl;

import org.apache.commons.lang.StringUtils;
import org.apache.jackrabbit.util.ISO8601;
import org.jahia.api.Constants;
import org.jahia.modules.sociallib.ActivityRecorder;
import org.jahia.modules.sociallib.ActivityRecorderRegistry;
...
/**
 * Social service implementation for manipulating social activities data.
 *
 * @author Serge Huber
 */
    ...
    public void createSocialConnection(final String fromUserKey, final String toUserKey, final String connectionType)
        ...
        execute(new JCRCallback<Boolean>() {
            public Boolean doInJCR(JCRSessionWrapper session) throws RepositoryException {
                ...
                JCRNodeWrapper leftUserConnection = leftConnectionsNode.addNode(leftUser.getName() + "-" + rightUser.getName(), SocialServiceImpl.JNT_SOCIAL_CONNECTION);
                ...
                JCRNodeWrapper rightUserConnection = rightConnectionsNode.addNode(rightUser.getName() + "-" + leftUser.getName(), SocialServiceImpl.JNT_SOCIAL_CONNECTION);
